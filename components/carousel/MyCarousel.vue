...
<div>
  ...
  <ul id="light-slider" >
    <li>
      <div class="box">
        <button class="btn">Hellow dead worl</button>
        <div class="slide_img">
          <img src="https://robohash.org/sdf2?set=set2" alt="product" />
          <!---SECTION OverLay  -->
          <div class="overlay">
        ...
        <div class="detail_box">
          <div class="type">
            <a href="">Rabed Cardigan </a>
            <span>Noe Arival</span>
          </div>
...
.overlay {
  ...
  width: 100%;
  height: 100%;
  background-color: rgba(107, 107, 197, 0.6);
  display: flex;
  justify-content: center;
  align-items: center;
  visibility: hidden;
